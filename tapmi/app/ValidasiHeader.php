												              ...
												              FROM (  SELECT data_source,
												                        ...
												                        FROM (SELECT data_source,
												                                ...
												                                FROM (SELECT 'MI' AS data_source,
												                                      ...
												                                      UNION
												                                      SELECT 'ME' AS data_source,
												                                      		 ebcc_code ebcc_validation_code,
												                                             werks,
												                                             afd_code,
												                                             block_code,
												                                             tph_code no_tph,
												                   ...
												                   LEFT JOIN (SELECT tanggal_rencana,
												                      ...
												                      ON     TRUNC (ebcc.tanggal_rencana) = TRUNC (val_date_time)
												                         ...
												                         AND ebcc.kode_delivery_ticket = NVL (val_delivery_ticket, '-'))
												SELECT *
												  FROM tbl
